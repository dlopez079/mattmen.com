<section id="hero">
    <div class="relative bg-black overflow-hidden">
          ...
          <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div class="sm:text-center lg:text-left">
              ...
              <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Front-End and Back-End Developer with experience as a Graphic Designer, Project Manager, and IT Managed Service Consultant.
              </p>
      ...
      <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 py-6">
        <img class="animate-pulse h-56 w-full sm:h-72 md:h-96 lg:w-full lg:h-full" src="{{ asset('/img/SVG/mmlogo.svg') }}" alt="Mattmen Logo">
      </div>
    </div>
  </section>